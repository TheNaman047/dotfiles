...
-- Vendored from https://github.com/paulbkim-dev/vim-herdr-navigation (editor/nvim.lua)
--
...
-- (if any) or plain wincmd, so the tmux setup keeps working.
--
-- Lives in after/plugin so it loads last and wins over vim-tmux-navigator's
-- own <C-h/j/k/l> mappings. The herdr side is the vim-herdr-navigation plugin:
